...
what arrives into typed :class:`~meshtools.core.events.MeshEvent` values, and fans each
...
just one subscriber (see :class:`~meshtools.services.monitor_service.MonitorService`), and
...
The hub is session-scoped state on the :class:`~meshtools.context.AppContext`
