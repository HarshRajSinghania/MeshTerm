...
:class:`~meshtools.context.AppContext`. Running with no subcommand launches the
...
app = typer.Typer(
    ...
    help="MeshTools — a modern toolkit for tuning and exploring your MeshCore mesh.",
)
...
def run_tool_command(tool: Tool, params: dict) -> None:
    ...
    try:
        ...
        # Ambiguous/absent device: show the guidance message, not a traceback.
