...
def configure_logging(
    ...
    *,
    ...
    Args:
        ...
        log_dir: Directory for the ``meshtools.log.jsonl`` event file.
        level: Console log level.
        quiet: When ``True``, suppress console output (file logging continues).

    Returns:
        The configured ``meshtools`` logger.
    """
    ...
    file_handler = logging.FileHandler(log_dir / "meshtools.log.jsonl", encoding="utf-8")
