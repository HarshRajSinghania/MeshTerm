...
(:meth:`~meshtools.persistence.repository.Repository.heard_nodes`), our own node is added when
...
:mod:`meshtools.ui.map_screen`). On the CLI it prints a one-shot render fitted to the nodes.
