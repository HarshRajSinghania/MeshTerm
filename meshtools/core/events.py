...
any number of interested subscribers (see :class:`~meshtools.services.event_hub.EventHub`).
...
(:class:`~meshtools.core.models.Observation`), inbound text messages
(:class:`~meshtools.core.models.Message`), and delivery acknowledgements
(:class:`~meshtools.core.models.Ack`). Further kinds (contact updates, path changes) slot
...
class MeshEvent:
    ...
    kind-specific data (an :class:`~meshtools.core.models.Observation` for
