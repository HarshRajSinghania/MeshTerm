...
:class:`~meshtools.ui.tui.screen.Screen` layers, and the persistent header/footer frame. It
...
:mod:`~meshtools.ui.tui.frame`, and exposes ``async`` helpers (``select``/``text``/
...
class TuiSession:
    ...
    def __init__(
        ...
        *,
        ...
        self._header = header or (lambda: Text("MeshTools", style="brand"))
    ...
    async def run_screen(self, screen: Screen) -> Any:
        ...
        Returns:
            The screen's resolved value, or :data:`~meshtools.ui.tui.screen.CANCEL`.
        """
