...
:mod:`~meshtools.ui.tui.render`) and how to react to normalized key *actions* dispatched by
the :class:`~meshtools.ui.tui.session.TuiSession`. Screens never touch prompt_toolkit or the
