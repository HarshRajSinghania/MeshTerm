...
The MeshCore app traces a route once. Because MeshTerm persists every trace, it can
...
It is pure logic over :class:`~meshterm.core.models.TraceResult` lists; the pyvis
renderer in :mod:`meshterm.viz.route_graph` draws the result.
"""
